INSERT INTO app_user (id, username, password, active, created_at) VALUES ('7f000001-8a56-11d1-818a-56e25ae30000', 'admin', '{noop}secret', true, NOW());
INSERT INTO app_user (id, username, password, active, created_at) VALUES ('7f000001-8a56-1695-818a-56687e770000', 'user', '{noop}secret', true, NOW());
